                ...
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="active"><a class="nav-link" href="Enroll-table.asp"><i class="fas fa-table"></i><span>Table</span></a></li>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <%
                                        ...
                                        set Data = Conn.execute("Select * from Enrollment")
                                    %>
                                    <table class="table">
                                        <thead>
                                            <th scope="col">#</th>
                                        ...
                                        <form method="post" action="DeleteE.asp?id=<%=Data("ID")%>" id="del">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><%=Data("Grade")%></td>
                                                <td>
                                                    <a href="Enroll-form.asp?id=<%=Data("ID")%>" class="btn btn-icon btn-primary btn-sm"><i class="far fa-edit"></i></a>
                                                    <button type="submit" form="del" class="btn btn-icon btn-danger btn-delete btn-sm"><i class="fas fa-trash"></i></button>
                                                </td>
                                            </tr>
                                            <%
                                                Data.MoveNext()
