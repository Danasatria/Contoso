<%
    ...
    if (cint(id) <> 0) then 
        Set Data = Conn.execute("Select * from Course where ID = " & id)
        ...
        <div class="main-wrapper">
            ...
            <div class="main-content">
                ...
                <div class="section-body">
                    <form method="post" action="ConnC.asp">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control phone-number" name="Title" value="<%=Title%>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Credits</label>
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control phone-number" name="Credits" value="<%=Credits%>">
                                    </div>
                                </div>
