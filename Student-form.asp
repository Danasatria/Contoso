<%
    ...
    if (cint(id) <> 0) then 
        Set Data = Conn.execute("Select * from Student where id = " & id)
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="active"><a class="nav-link" href="Student-table.asp"><i class="fas fa-table"></i><span>Table</span></a></li>
            ...
            <div class="main-content">
                ...
                <div class="section-header">
                    ...
                    <div class="section-header-breadcrumb">
                        ...
                        <div class="breadcrumb-item active"><a href="Student-table.asp">Table</a></div>
                        <div class="breadcrumb-item">Form</div>
                    </div>
                </div>

                <div class="section-body">
                    <form method="post" action="ConnS.asp">
                        <div class="card">
                            <div class="card-header">
                                <h4>Student Add</h4>
                            </div>
                            <div class="form-group">
                                <input type="Hidden" class="form-control daterange-cus" name="ID" value="<%=ID%>">
                            </div>
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control phone-number" name="LastName" value="<%=LastName%>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control phone-number" name="FirstMidName" value="<%=FirstMidName%>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" class="form-control daterange-cus" name="EnrollmentDate" value="<%=EnrollmentDate%>">
                                    </div>
                                </div>
